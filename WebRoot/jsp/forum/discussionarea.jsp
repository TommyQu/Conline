...
<jsp:include page="/jsp/template/head.jsp" >
	<jsp:param name="application-title" value="DiscussionArea" />
...
<script type="text/javascript" src="js/forum/discussionarea.js"></script>
<%
...
<table id="outside">
  ...
  <tr>
    ...
    <td id="gettopic"><a href="post?action=getonepost&topicId=<%=lvcftl.get(i).getId()%>" /><%=lvcftl.get(i).getTopic()%></td>
